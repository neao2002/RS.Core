...
namespace RS.Lib.Data
{
    ...
    internal class DataConnInfo
    {
        ...
        private bool IsGlobalDB = false;//是否为全局缓存对象
        ...
        public DataConnInfo(DbConnection cnn)
        {
            ...
            {
                db = new AccessDb((OleDbConnection)cnn);
                DbDriverType = DbDriverType.Access;
            }
            else
            {
                DbDriverType = DbDriverType.Define;
        ...
        public DataConnInfo(DbConnection cnn,DbTransaction tran)
        {
            ...
            {
                db = new AccessDb((OleDbConnection)cnn,(OleDbTransaction)tran);
                DbDriverType = DbDriverType.Access;
            }
            else
            {
                ...
                if (db == null)
                {
                    ...
                    { 
                        ...
                        case DbDriverType.Oracle:
                            ...
                            break;
                        case DbDriverType.Access:
                            db = new AccessDb(connectionString);
                            break;

...
namespace RS.Lib
{
    ...
    {        
        ...
        protected DbUtils(string connStr, Type DbType)
        {
        ...
        protected DbUtils(string ConnectionString, DbDriverType type)
        {
            LinkInfo = new DataConnInfo(ConnectionString, type);
        }

        protected DbUtils(DbConnection cnn)
        {
            LinkInfo = new DataConnInfo(cnn);
        }
        protected DbUtils(DbConnection cnn,DbTransaction mytran)
        {
            LinkInfo = new DataConnInfo(cnn,mytran);
        }
        protected DbUtils(DbConnection cnn, DbDriverType type)
        {

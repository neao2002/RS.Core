...
namespace RS
{
    ...
    public static class LibHelper
    {
        ...
        {
            return Global.DbContextFactory.CreateContext();
        }
        /// <summary>
        /// 创建数据访问对象实例
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static bool IsDbConnected(this DbContext db)
        {
            bool rtn = false;
            try
            {
        ...
        public static IFilter CreateIFilter(IDbContext db = null)
        {
        ...
        #region 读取配置文件(通过依赖注入方式由外部应用方式取到相应信息)
        ...
        /// <summary>
        /// 获取指定健值的配置值,如果未有该键值或未初始化，则为空
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        public static string GetAppSetting(string key)
        {
            return Global.GetAppSetting(key);
        }
        /// <summary>
        /// 获取配置中数据链接字符串
        /// </summary>
        ...
        {
            return Global.GetConnectionString(name);
        }
        #endregion

...
namespace RS.Data
{
    public class SearchItem
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<DynamicObj> GetDataSource()
        {
        ...
        /// <returns></returns>
        private string GetItemFitler(string FN, IDbContext Db)
        {
            ...
            if (Value1 == DBNull.Value || Value1 == null)  //当检索值为空值时（1、未设置该检索项；2、该检索项确实为空值）
            {
                ...
                CompareType = CompareType.BigOrEqual;
        ...
        /// <param name="Db"></param>
        /// <returns></returns>
        private string GetDateFilter(string FN, object V1, IDbContext Db)
        {
            ...
            if (DataType == FilterDataType.String)
            {
                ...
                if (DateFormat.IsWhiteSpace())
                {
                    ...
                    {
                        case DateCompareType.Date:
                            fm = "{0:yyyy-MM-dd}";
                            break;
                        case DateCompareType.DateTime:
                            fm = "{0:yyyy-MM-dd HH:mm:ss}";
                            break;
                        case DateCompareType.Month:
                            fm = "{0:yyyy-MM}";
                            break;
                        case DateCompareType.Year:
                            fm = "{0:yyyy}";
                            break;
                        default:
                            fm = "{0:yyyy-MM-dd}";
                ...
                switch (CompareType)
                {
                    ...
                    case CompareType.NotDBNull:
                        ...
                        break;
                    case CompareType.RightComprise:
                    ...
                    case CompareType.Between:
                        switch (DateCompareType)
                        {
                            ...
                            case DateCompareType.DateTime:
                                ...
                                break;
                            case DateCompareType.Month://月份比较//(ay>2011 or (ay=2011 and am>=7)) and (ay<2012 or (ay=2012 and am<=3))
                    ...
                    case CompareType.BigOrEqual:
                        switch (DateCompareType)
                        {
                            ...
                            case DateCompareType.DateTime:
                                ...
                                break;
                            case DateCompareType.Month://月份比较//(ay>2011 or (ay=2011 and am>=7))
        ...
        private string GetFilter(string FN, object V1, IDbContext Db)
        {
